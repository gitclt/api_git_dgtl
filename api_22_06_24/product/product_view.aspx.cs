...
public partial class api_country_add : System.Web.UI.Page
{
    ...
    public void getdata()
    {
        ...
        string querry1 = @"SELECT p.product_name,p.product_market,p.pattern_id,pt.name AS product_type, p.material_id, p.gsm_id, p.size, p.color,p.id,p.producttype_id,p.hsn_sac,m.name as material,pn.name as pattern,g.name as gsm
                 FROM tbl_product p
