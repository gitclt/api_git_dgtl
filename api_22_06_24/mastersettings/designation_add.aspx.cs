...
public partial class api_country_add : System.Web.UI.Page
{
    ...
    public void insert()
    {
        ...
        foreach (var data in DataResponse)
        {
            ...
            if (data.type == "add")
            {
                querry1 = @"insert into tbl_designation (name,delete_status) values('" + data.name + "',0)";
            ...
            {
                querry1 = @"update tbl_designation set name='" + data.name + "' where id=" + data.id + " ";
            ...
            //{
            //    querry1 = @"update tbl_designation set delete_status=1 where id=" + data.id +" and name='supervisor' ";
            ...
            {
                if (data.name.ToLower() == "supervisor")
                {
                    message = "deleting the name to 'supervisor' is not allowed.";
