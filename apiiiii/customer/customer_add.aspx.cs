    ...
    public void insert()
    {
        ...
        foreach (var data in DataResponse)
        {
            ...
            if (isValid)
            {
                if (data.type == "add")
                {
                    querry = @"select id from tbl_customer where mobile='" + data.mobile + "'";
                    ...
                    (first_name,last_name,company_name,mobile,email,
                     billing_address,billing_city,billing_state,billing_district,billing_country,billing_phone,billing_pin,
                     gstno,delete_status,added_on,added_by,modified_by,modified_on,modified_type,
                    shipping_address,shipping_city,shipping_state,shipping_country,shipping_district,
                   shipping_phone,shipping_pin,code,customer_type) 
                    values('" + data.first_name + "','" + data.last_name + "','" + data.company_name + "','" + data.mobile + "','" + data.email + "'," +
                    "'" + data.billing_address + "','" + data.billing_city + "','" + data.billing_state + "','" + data.billing_district + "','" + data.billing_country + "','" + data.billing_phone + "','" + data.billing_pin + "','" +
                        data.gstno + "',0,getdate(),'" + data.added_by + "','" + data.added_by + "',getdate(),'" + data.added_by + "'," +
                        "'" + data.shipping_address + "','" + data.shipping_city + "','" + data.shipping_state + "','" + data.shipping_country + "'," +
                        "'" + data.shipping_district + "','" + data.shipping_phone + "','" + data.shipping_pin + "','" + data.code + "','"+data.customer_type + "')";
                ...
                {
                    querry1 = @"update  tbl_customer  set delete_status=1,deleted_on = GETDATE(),deleted_by = '"+ data.empid + "',ip_address='" + data.ip_address+"' where id=" + data.id + " ";
