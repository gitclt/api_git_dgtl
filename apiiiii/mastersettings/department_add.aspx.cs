...
public partial class api_country_add : System.Web.UI.Page
{
    ...
    public void insert()
    {
        ...
        foreach (var data in DataResponse)
        {
            ...
            if (data.type == "add")
            {
                querry1 = @"insert into tbl_dept (name,delete_status) values('" + data.name + "',0)";
            ...
            {
                querry1 = @"update tbl_dept set name='" + data.name + "' where id=" + data.id + " ";
            ...
            {
                querry1 = @"update tbl_dept set delete_status=1 where id=" + data.id + " ";
