    ...
    public void insert()
    {
        ...
        foreach (var data in DataResponse)
        {
            ...
            if (data.type == "add")
            {
                ...
                querry1 = @"insert into tbl_grade (name,delete_status) values('" + data.name + "',0)";
            ...
            {
                querry1 = @"update tbl_grade set name='" + data.name + "' where id=" + data.id + " ";
            ...
            {
                querry1 = @"update tbl_grade set delete_status=1 where id=" + data.id + " ";
