...
public partial class api_catlog_add_wishlist : System.Web.UI.Page
{
    ...
    public void getdata(string username, string password)
    {
        ...
        string querry = @"select * from tbl_user 
            where username='" + EncodeDecode.base64Encode(username) + "' and password='" + EncodeDecode.base64Encode(password) + "'";
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (ds.Tables[0].Rows[0]["enc_key_date"].ToString() == "")
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    json += "{'emp_id':'" + ds.Tables[0].Rows[i]["emp_id"].ToString() + "','enc_key':'" + tok + "'},";
                }
