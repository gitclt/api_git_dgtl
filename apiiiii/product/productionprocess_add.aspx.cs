...
public partial class api_country_add : System.Web.UI.Page
{
    ...
    public void insert()
    {
        ...
        if (data.product_production_process != null && data.product_production_process.grade != null)
        {
            ...
            {
                string querry1 = @"select id from tbl_product_production_process_grade where pro_id='"+data.pro_id+"' and  production_process_id='" + data.product_production_process.product_production_process_id + "' and grade_id='"+grade.grade_id+"'";
                DataSet ds = cc.joinselect(querry1);
                if (ds.Tables[0].Rows.Count > 0)
                {
                    string message = "Production process already exists.";
                ...
                else
                {
                     ...
                     querry1 = @"INSERT INTO tbl_product_production_process_grade (pro_id, production_process_id, output_per_sec, grade_id) 
