...
o.packing_status as itemspacking_status,
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (var order in ordersDict)
            {
                ...
                json += "'pm_id':'" + ds.Tables[0].Rows[0]["pm_id"].ToString() + "',";
                json += "'pm_remark':'" + ds.Tables[0].Rows[0]["pm_remark"].ToString() + "',";
                json += "'pm_delivery':'" + ds.Tables[0].Rows[0]["pm_delivery"].ToString() + "',";
