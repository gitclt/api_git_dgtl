...
WHERE 
  ...
  .CopyToDataTable();
            for (int i = 0; i < items.Rows.Count; i++)
            {
                ...
                json += "'production_packing_status':'" + items.Rows[i]["production_packing_status"].ToString() + "',";              
...
where  pro_id=" + items.Rows[i]["pro_id"].ToString();
                ...
                if (dsw.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        json += "{'process_type':'" + dsw.Tables[0].Rows[j]["process_type"].ToString() + "'";
                        json += ",'process_name':'" + dsw.Tables[0].Rows[j]["process_name"].ToString() + "'";
                        json += ",'production_process_id':'" + dsw.Tables[0].Rows[j]["production_process_id"].ToString() + "'";
                        json += ",'grade_id':'" + dsw.Tables[0].Rows[j]["grade_id"].ToString() + "'";
                        json += ",'output_per_sec':'" + dsw.Tables[0].Rows[j]["output_per_sec"].ToString() + "'},";
