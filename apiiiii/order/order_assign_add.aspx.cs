...
public partial class api_country_add : System.Web.UI.Page
{
    ...
    public void insert()
    {
        ...
        foreach (var data in DataResponse)
        {
            ...
            string insertQuery = @"INSERT INTO tbl_order_assigned (emp_id, item_id, qty, remark, addedby, addedon, target_date, production_status, packing_status, job_type,production_packing_status) " +
                                     "VALUES('" + data.emp_id + "','" + data.item_id + "','" + data.qty + "','" + data.remark + "','" + data.addedby + "', GETDATE(),'" + data.target_date + "',"+production_status+","+packing_status+",'" + data.job_type + "','"+data.production_packing_status+"')";
