...
public partial class api_country_add : System.Web.UI.Page
{
    ...
    public class DataResponse
    {
        ...
        public string istakenfromstock;
        public string expected_quantity_remark;
    ...
    public void insert()
    {
        ...
        foreach (var data in dataResponses)
        {
            ...
            {
                querry1 = @"INSERT INTO tbl_order_task(addedby,order_assign_id,fromdatetime,addedon,no_of_emp,istakenfromstock,start_end) " +
                          "VALUES('" + data.addedby + "','" + data.order_assign_id + "','" + data.datetime + "', GETDATE(),'" + data.no_of_emp + "','" + data.istakenfromstock + "','" + data.task_start_end_flag + "')";
            }
            else
            {
                querry1 = @"update tbl_order_task set expected_qty='" + data.expected_qty + "',workhour='"+data.workhour+ "',expected_quantity_remark='" + data.expected_quantity_remark + "',remark='" + data.remark+"',todatetime='"+data.datetime+"',qty='"+data.qty+ "',start_end='" + data.task_start_end_flag + "' where id='"+data.task_id+"'";
            }
...
(task_id,activity,pro_id) 
   values('" + task_id + "','" + activity.production_process_id + "','"+activity.pro_id+"')";
