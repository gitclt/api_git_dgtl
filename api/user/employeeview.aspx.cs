...
where e.delete_status=0 and u.type<>'admin'
order by e.name 
            ";
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    json += "{'id':'" + ds.Tables[0].Rows[i]["id"] + "','name':'" + ds.Tables[0].Rows[i]["name"] + "','email':'" + ds.Tables[0].Rows[i]["email"] + "','phone':'" + ds.Tables[0].Rows[i]["phone"] + "','designation_name':'" + ds.Tables[0].Rows[i]["designation_name"] + "','join_date':'" + ds.Tables[0].Rows[i]["join_date"] + "','designation_id':'" + ds.Tables[0].Rows[i]["designation_id"] + "','hierarchy':'" + ds.Tables[0].Rows[i]["hierarchy"] + "','image_path':'" + path + "','image':'" + ds.Tables[0].Rows[i]["image"].ToString() + "','last_name':'" + ds.Tables[0].Rows[i]["last_name"].ToString() + "','employee_id':'" + ds.Tables[0].Rows[i]["employee_id"].ToString() + "','active_status':'" + ds.Tables[0].Rows[i]["active_status"].ToString() + "'},";
                }
                json = json.TrimEnd(',');
                json += "]}";
