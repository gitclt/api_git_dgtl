    ...
    public void insert()
    {
        ...
        foreach (var data in DataResponse)
        {
            ...
            if (data.type == "add")
            {
                ...
                querry = @"select id from tbl_pattern where name='" + data.name + "'  ";
                ...
                {
                    querry1 = @"insert into tbl_pattern (name,delete_status) values('" + data.name + "',0)";
            ...
            {
                querry1 = @"update tbl_pattern set name='" + data.name + "' where id=" + data.id + " ";
                message = "Data updated successfully.";

            }
            else if (data.type == "delete")
            {
                querry1 = @"update tbl_pattern set delete_status=1 where id=" + data.id + " ";
