        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                json += "{'first_name':'" + ds.Tables[0].Rows[i]["first_name"].ToString() + "','id':'" + ds.Tables[0].Rows[i]["id"].ToString() + "'," +
                    ...
                    "'shipping_state':'" + ds.Tables[0].Rows[i]["shipping_state"].ToString() + "','billing_state':'" + ds.Tables[0].Rows[i]["billing_state"].ToString() + "','shipping_district':'" + ds.Tables[0].Rows[i]["shipping_district"].ToString() + "','billing_district':'" + ds.Tables[0].Rows[i]["billing_district"].ToString() + "','code':'" + ds.Tables[0].Rows[i]["code"].ToString() + "','gstno':'" + ds.Tables[0].Rows[i]["gstno"].ToString() + "'},";
            }
            json = json.TrimEnd(',');
            json += "]}";
